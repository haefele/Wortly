...
import { StartPracticeDialog } from "@/app/learn/start-practice-dialog";
...
export function AppSidebar() {
  ...
  const [startPracticeDialogOpen, setStartPracticeDialogOpen] = useState(false);
  ...
  return (
    <>
                  ...
                  <HoverCardContent className="w-64">
                    <div className="space-y-3">
                      ...
                      <Button
                        size="sm"
                        className="w-full"
                        onClick={() => setStartPracticeDialogOpen(true)}
                      >
                        Practice now!
                      </Button>
                    </div>
      ...
      <StartPracticeDialog
        open={startPracticeDialogOpen}
        onOpenChange={setStartPracticeDialogOpen}
      />
    </>
  );
}
